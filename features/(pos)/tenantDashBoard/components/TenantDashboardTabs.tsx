      ...
      {activeTab === "machines" ? (
        ...
        <section className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-teal-100 bg-teal-50 p-5 dark:border-teal-900 dark:bg-teal-950">
            ...
            <div className="rounded-lg border border-orange-100 bg-orange-50 p-5 shadow-sm dark:border-orange-900 dark:bg-orange-950">
            ...
            <div
              className={`rounded-lg border p-5 ${
                lowStockItems.length > 0
                  ...
                  : "border-green-200 bg-green-50 shadow-sm dark:border-green-900 dark:bg-green-950"
              }`}
            >
          ...
          {inventoryItems.length === 0 ? (
            <div className="rounded-lg border border-dashed border-gray-300 bg-white p-10 text-center text-gray-500 dark:border-gray-700 dark:bg-gray-900">
