      ...
      {activeTab === "machines" ? (
        ...
        <section className="space-y-6">
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className={`rounded-lg border p-5 ${lowStockItems.length > 0 ? "border-red-200 bg-red-50" : "border-gray-200 bg-white shadow-sm"}`}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {inventoryItems.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`rounded-lg border p-5 shadow-sm ${isLowStock ? "border-red-200 bg-red-50" : "border-gray-200 bg-white"}`}
                  >
